...
describe("Digital #digital", function ()
    ...
    it("timed", function()
        ...
        lower.delay(.3)     lower.setIOCallback(8, cb)
        upper.delay(.3)     upper.turnOnTimed(8, 0.3)
    ...
    it("reverse", function()
        ...
        upper.delay(.3)     upper.setIOCallback(1, cb)
        lower.delay(.3)     lower.turnOn(1)
        lower.delay(.3)     lower.turnOff(1)
