...
describe("Digital #digital", function ()
    ...
    it("toggle", function()
        ...
        lower.delay(.3)     lower.setAllIOCallback(cb)
    ...
    it("timed", function()
        ...
        lower.delay(.2)     lower.setIOCallback(8, cb)
        upper.delay(.1)     upper.turnOnTimed(8, 0.3)
    ...
    it("reverse", function()
        ...
        upper.delay(.2)     upper.setIOCallback(1, cb)
        lower.delay(.1)     lower.turnOn(1)
        lower.delay(.2)     lower.turnOff(1)
